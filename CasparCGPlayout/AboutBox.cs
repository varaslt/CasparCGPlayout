    ...
    public partial class AboutBox : Form
	{
		...
		private NameValueCollection AssemblyAttribs(Assembly a)
		{
			...
			foreach (object attrib in a.GetCustomAttributes(false))
			{
				...
				string Name = r.Match(TypeName).Groups["Name"].ToString();
				string Value = "";
				switch (TypeName)
				{
					...
					case "System.Runtime.InteropServices.ComCompatibleVersionAttribute":
						{
						    ComCompatibleVersionAttribute x = ((System.Runtime.InteropServices.ComCompatibleVersionAttribute)attrib);
					...
					case "System.Runtime.InteropServices.TypeLibVersionAttribute":
						{
						    TypeLibVersionAttribute x = ((System.Runtime.InteropServices.TypeLibVersionAttribute)attrib);
		...
		private void AssemblyInfoListView_DoubleClick(object sender, EventArgs e)
		{
		    if (AssemblyInfoListView.SelectedItems.Count > 0){
				string strAssemblyName = Convert.ToString(AssemblyInfoListView.SelectedItems[0].Tag);
		...
		class ListViewItemComparer : System.Collections.IComparer
		{
			...
			{
				int intResult =
					System.String.CompareOrdinal(((ListViewItem)x).SubItems[_intCol].Text, ((ListViewItem)y).SubItems[_intCol].Text);
