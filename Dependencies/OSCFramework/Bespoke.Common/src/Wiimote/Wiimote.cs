...
namespace Bespoke.Common.Wiimote
{
    ...
    public delegate void UpdateWiimoteStateHandler(WiimoteChangedEventArgs args);
	...
	public class Wiimote : IDisposable
	{
        ...
        private static WiimoteCollection sWiimotes;

        /// <summary>
        /// Gets the collection of available Wiimotes
        /// </summary>
        public static WiimoteCollection AvailableWiimotes
        {
            get
            {
                return sWiimotes;
